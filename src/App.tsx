                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <input 
                        ...
                        step="0.000001"
                        value={location?.lat || ''} 
                        onChange={(e) => setLocation(prev => ({ ...prev!, lat: parseFloat(e.target.value) || 0, accuracy: 0 }))}
                    ...
                    <div className="space-y-2">
                      ...
                      <input 
                        ...
                        step="0.000001"
                        value={location?.lng || ''} 
                        onChange={(e) => setLocation(prev => ({ ...prev!, lng: parseFloat(e.target.value) || 0, accuracy: 0 }))}
                        className="w-full px-6 py-3 bg-brand-50 border border-brand-100 rounded-2xl text-xs font-medium focus:outline-none focus:ring-4 focus:ring-brand-600/5 focus:border-brand-600 transition-all"
                      />
                    </div>
                  </div>
